...
ChoixAttaque::ChoixAttaque(QWidget *parent) : QWidget(parent)
{
   ...
   QGridLayout* gridBouton = new QGridLayout;
   gridBouton->addWidget(attaque1_,0,0);
   gridBouton->addWidget(attaque2_,0,1);
   gridBouton->addWidget(attaque3_,1,0);
   gridBouton->addWidget(attaque4_,1,1);

   this->setLayout(gridBouton);

...
void Creature::modifierPouvoir(Pouvoir pouvoir) { pouvoir_ = pouvoir; }
...
void Creature::information() {
	...
	cout << "Il est au niveau " << niveau_ << " avec " << experience_ << " XP" << endl;
	cout << "Il lui manque " << experienceNecessaire_ << " XP jusqu'au prochain niveau" << endl;
};